...
using FinalProjectForAipLec.Services.Interfaces;
using FinalProjectForAipLec.Utilities;
using FinalProjectForAipLec.ViewModels.ManageViewModels;
...
namespace FinalProjectForAipLec.Web.Controllers
{
    [Authorize]
    ...
    public class ManageController : BaseController
    {
        ...
        private string GenerateQrCodeUri(string email, string unformattedKey)
        {
            return string.Format(
                ...
                _urlEncoder.Encode("FinalProjectForAipLec.Web"),
